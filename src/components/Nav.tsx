...
export const Nav = () => {
    ...
    return (
        <nav className="fixed top-[0] left-[0] w-full z-[20] flex justify-between items-center px-[30px] pt-[30px]">
            ...
            <div className="absolute left-0 right-0 mx-auto top-[calc(30px+56px+32px)] lg:top-[30px] h-[56px] w-auto gap-[48px] hidden md:flex justify-center items-center pointer-events-none">
                <button className={clsx(
                    "text-[12px] tracking-[0.3em] px-[10px] h-[24px] pt-[3px] uppercase pointer-events-auto",
                    activeIndex === 1 && "text-dark-1 bg-primary",
                    activeIndex !== 1 && "text-primary"
                )} onClick={() => handleSceneChange(1)}>projects</button>

                <button className={clsx(
                    "text-[12px] tracking-[0.3em] px-[10px] h-[24px] pt-[3px] uppercase pointer-events-auto",
                    activeIndex === 3 && "text-dark-1 bg-primary",
                    activeIndex !== 3 && "text-primary"
                )} onClick={() => handleSceneChange(3)}>services</button>

                <button className={clsx(
                    "text-[12px] tracking-[0.3em] px-[10px] h-[24px] pt-[3px] uppercase pointer-events-auto",
                    activeIndex === 5 && "text-dark-1 bg-primary",
                    activeIndex !== 5 && "text-primary"
                )} onClick={() => handleSceneChange(5)}>scene 3</button>

                <button className={clsx(
                    "text-[12px] tracking-[0.3em] px-[10px] h-[24px] pt-[3px] uppercase pointer-events-auto",
                    activeIndex === 7 && "text-dark-1 bg-primary",
                    activeIndex !== 7 && "text-primary"
                )} onClick={() => handleSceneChange(7)}>scene 4</button>

                <button className={clsx(
                    "text-[12px] tracking-[0.3em] px-[10px] h-[24px] pt-[3px] uppercase pointer-events-auto",
                    activeIndex === 9 && "text-dark-1 bg-primary",
                    activeIndex !== 9 && "text-primary"
                )} onClick={() => handleSceneChange(9)}>about</button>
            ...
            <div>
                <button
                    className="btn-primary-orange w-full justify-center btn-sm md:btn-lg"
                >
                    Get in touch
                </button>
            </div>
